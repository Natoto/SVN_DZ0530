...
@interface B3_PortalViewController : Base_TableviewController <UITableViewDelegate, UITableViewDataSource, B3_PostTableView_HeadCellDelegate, B3_PostTableView_CellDelegate, UITextViewDelegate>
{
...
@property (nonatomic, strong) ArticleReplyModel         *articleReplyModel;
@property (nonatomic, strong) collectModel              *collectModel;
@property (nonatomic, strong) delcollectionModel        *delcollectionModel;
@property (nonatomic, strong) favoritearticleModel      *favoritearticleModel;
@property (nonatomic, strong) delfavoritearticleModel   *delfavoritearticleModel;
...
@property (nonatomic, strong) NSNumber                  *articleType;           //文章类型
