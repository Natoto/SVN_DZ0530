...
-(UILabel *)lbllouzhu
{
    if (!_lbllouzhu) {
        ...
        _lbllouzhu.textAlignment = NSTextAlignmentLeft;
...
//    [self.lbllouzhu sizeToFit];
    ...
    self.lbllouzhu.frame = CGRectMake(LEFT, CGRectGetMaxY(self.line.frame),CGRectGetMinX(self.viewicon.frame) - LEFT, 20);
}
