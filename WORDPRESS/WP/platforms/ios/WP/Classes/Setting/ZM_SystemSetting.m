...
-(id)init
{
    ...
    if (self) {
        ...
        self.umengappkey =[NSString stringWithFormat:@"%@",[[diction valueForKey:@"umappkey"] valueForKey:@"text"]];
        self.umchannelId = [self checkstring:self.umengappkey optionalstr:@"540e9109fd98c5287b000179"];
