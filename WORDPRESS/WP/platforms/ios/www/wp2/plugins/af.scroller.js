...
(function ($) {
    ...
    var scroller = (function () {
        ...
        scrollerCore.prototype = {
            ...
            refresh: false,
            refreshContent: strPullToRefresh,
            ...
            coreAddPullToRefresh: function (rEl) {
                ...
                if (this.refreshElement === null) {
                    ...
                    if (orginalEl !== null) {
                        ...
                        afEl = $("<div id='" + this.container.id + "_pulldown' class='afscroll_refresh' style='position:relative;height:120px;text-align:center;line-height:120px;font-weight:bold;'>" + this.refreshContent + "</div>");
                    }
                } else {
            ...
            fireRefreshRelease: function (triggered) {
                ...
                this.setRefreshContent(strRefreshDeviceid);
        ...
        nativeScroller.prototype.addPullToRefresh = function (el, leaveRefresh) {
            ...
            if (this.refresh && this.refresh === true) {
                ...
                this.refreshContainer.style.top = "-120px";
                this.refreshContainer.style.height = "120px";
        ...
        nativeScroller.prototype.onTouchMove = function (e) {
            ...
            //check for cancel when refresh is running
                ...
                this.setRefreshContent(strPullToRefresh);
        ...
        nativeScroller.prototype.showRefresh = function () {
            if (!this.refreshTriggered) {
                ...
                this.setRefreshContent(strReleaseToRefresh);
        ...
        nativeScroller.prototype.hideRefresh = function (animate) {
            ...
            var endAnimationCb = function (canceled) {
                that.refreshContainer.style.top = "-120px";
                ...
                if (!canceled) { //not sure if this should be the correct logic....
                    ...
                    that.setRefreshContent(strPullToRefresh);
        ...
        jsScroller.prototype.onTouchMove = function (event) {
            ...
            if (this.infinite && !this.infiniteTriggered) {
                ...
                if ((Math.abs(this.lastScrollInfo.top) > (this.el.clientHeight - this.container.clientHeight))) {
                	//huadd
                	if (this.lastScrollInfo.deltaY < 0) {
                    this.infiniteTriggered = true;
                    $.trigger(this, "infinite-scroll");
                  }
                }
        ...
        jsScroller.prototype.onTouchEnd = function (event) {
            ...
            //huadd
            if (triggered) {
            	//var dd = this.lastEventInfo;
            	//var ee=this.firstEventInfo;
            		 if (scrollInfo.absDeltaY>500) {
            			triggered = false;
            		}
            }
           ...
           setTimeout(function(){
             ...
             //if (scrollInfo.duration > 340) {
   			//this.scrollerMoveCSS(scrollInfo, scrollInfo.duration/2, "cubic-bezier(0.33,0.66,0.66,1)");
          //  this.scrollerMoveCSS(scrollInfo, scrollInfo.duration, "cubic-bezier(0.33,0.66,0.66,1)");
            this.setVScrollBar(scrollInfo, scrollInfo.duration, "cubic-bezier(0.0,0.0,1,1)");
