...
#import "B2_HotestViewController.h"

@interface B2_HotestViewController ()

@end

@implementation B2_HotestViewController
...
ON_SIGNAL3(Hot_TopiclistModel, RELOADED, signal)
{
...
{
    [super viewDidLoad];
    self.tpclistModel =[Hot_TopiclistModel modelWithObserver:self];
