...
#import "B2_BestViewController.h"

@interface B2_BestViewController ()

@end

@implementation B2_BestViewController
...
{
    [super viewDidLoad];
    self.tpclistModel =[Best_TopiclistModel modelWithObserver:self];
