...
#import "B2_TopestViewController.h"

@interface B2_TopestViewController ()

@end

@implementation B2_TopestViewController
...
{
    [super viewDidLoad];
    self.tpclistModel =[Top_TopiclistModel modelWithObserver:self];
