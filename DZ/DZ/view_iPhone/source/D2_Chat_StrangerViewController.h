...
@class D2_Chat_StrangerViewController;
@protocol D2_ChatViewControllerDelegate <NSObject>
-(void)messageSendSuccess:(D2_Chat_StrangerViewController *)viewController;
@end

@interface D2_Chat_StrangerViewController : Base_TableviewController
