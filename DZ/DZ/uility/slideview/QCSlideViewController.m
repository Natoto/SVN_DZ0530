...
//        self.edgesForExtendedLayout = UIEdgeInsetsZero;// UIRectEdgeNone;
//       #endif
//    }
    ...
    self.vc1 = [[B2_QCListViewController alloc] init];
    self.vc1.title = @"清忧Saup";
    
    self.vc2 = [[B2_QCListViewController alloc] init];
    self.vc2.title = @"清澈Saup";
    
    self.vc3 = [[B2_QCListViewController alloc] init];
    self.vc3.title = @"清静Saup";
    
    self.vc4 = [[B2_QCListViewController alloc] init];
    self.vc4.title = @"清秋Saup";
    
    self.vc5 = [[B2_QCListViewController alloc] init];
    self.vc5.title = @"清晓Saup";
    
    self.vc6 = [[B2_QCListViewController alloc] init];
