...
//        CGRect lbltimeframe = CGRectMake(290 - 200 - CELLICONWITH + 3, TITLEHEIGHT+MARGINV+LABELHEIGHT, 200, LABELHEIGHT);
        CGRect lbltimeframe = CGRectMake(self.frame.size.width - 150 - 15, TITLEHEIGHT+MARGINV+LABELHEIGHT, 60, LABELHEIGHT);
...
//        _lbltime.frame = CGRectMake(CGRectGetMinX(_cellicon.frame) - 70 , WUTUY, 70, LABELHEIGHT);
//        _lbltime.textAlignment = 0;
        ...
        _lblreply.frame = CGRectMake(CGRectGetMaxX(reply.frame), YOUTUY, CKPLWIDTH, LABELHEIGHT);
          ...
          _lbltime.frame = CGRectMake(CGRectGetMinX(reply.frame) + 2, WUTUY, 70, LABELHEIGHT);
...
//        message.text = atopic.message;
        ...
        _lbltime.frame = CGRectMake(CGRectGetMaxX(_lbltitle.frame) - 70, YOUTUY, 50, LABELHEIGHT);
...
//        _lbltime.textAlignment = 2;
        ...
        _lblreply.frame = CGRectMake(CGRectGetMaxX(reply.frame) + 2 , YOUTUY, CKPLWIDTH, LABELHEIGHT);
