...
- (void)viewDidLoad
{
    ...
    [ServerConfig sharedInstance].aboutUsLeftArray = [NSMutableArray arrayWithArray:@[@"简介：", @"邮箱：", @"QQ：", @"网站：",@"Bundle identifier: ",@"内部版本号:"]];
    [ServerConfig sharedInstance].aboutUsRightArray = [NSMutableArray arrayWithArray:@[abstract, email, qq, website,identifier, clientversion]];
